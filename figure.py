...
class King(Figure):
    def __init__(self, tile, color):
        ...
        self.image = pg.transform.scale2x(pg.image.load(f"images/KING_{self.color.upper()}.png"))
...
class Bishop(Figure):
    def __init__(self, tile, color):
        super().__init__(tile, color)
        self.image = pg.transform.scale2x(pg.image.load(f"images/Bishop_{self.color.upper()}.png"))
        self.where_to_go = self.moving_pattern()
        self.symb = "B"
        self.value = 3
    def moving_pattern(self):
...
class Rook(Figure):
    def __init__(self, tile, color):
        super().__init__(tile, color)
        self.image = pg.transform.scale2x(pg.image.load(f"images/Rook_{self.color.upper()}.png"))
        self.where_to_go = self.moving_pattern()
        self.symb = "R"
        self.moved = False
        self.value = 5
...
class Knight(Figure):
    def __init__(self, tile, color):
        super().__init__(tile, color)
        self.image = pg.transform.scale2x(pg.image.load(f"images/Knight_{self.color.upper()}.png"))
        self.where_to_go = self.moving_pattern()
        self.symb = "N"
        self.value = 3
    def moving_pattern(self):
...
class Pawn(Figure):
    def __init__(self, tile, color):
        super().__init__(tile, color)
        self.image = pg.transform.scale2x(pg.image.load(f"images/Pawn_{self.color.upper()}.png"))
        self.where_to_go = self.moving_pattern()
        self.symb = ""
        self.value = 1
        self.lastMove = tile
...
class Queen(Figure):
    def __init__(self, tile, color):
        super().__init__(tile, color)
        self.image = pg.transform.scale2x(pg.image.load(f"images/Queen_{self.color.upper()}.png"))
